                ...
                <header className="flex justify-between items-end mb-12">
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-zinc-600 text-xs font-bold uppercase tracking-widest">Gestión de Inventario</span>
                        </div>
                    ...
                    <button
                        ...
                        className="bg-primary hover:bg-secondary text-white font-display font-black py-4 px-8 rounded-xl uppercase tracking-[0.2em] text-sm shadow-xl shadow-primary/20 transition-all hover:scale-[1.02] active:scale-95 italic flex items-center gap-2"
                    >
